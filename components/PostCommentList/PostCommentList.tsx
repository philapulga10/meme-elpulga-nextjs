  ...
  return (
    <div className="ass1-comments">
      ...
      <div className="ass1-comments__section">
        <a href="#" className="ass1-comments__avatar ass1-avatar"><img src="/Fimages/avatar-02.png" alt="" /></a>
      ...
      {/*comment*/}
      <div className="ass1-comments__section">
        <a href="#" className="ass1-comments__avatar ass1-avatar"><img src="/Fimages/avatar-11.png" alt="" /></a>
        <div className="ass1-comments__content">
          ...
          {/*comment*/}
          <div className="ass1-comments__section">
            <a href="#" className="ass1-comments__avatar ass1-avatar"><img src="/Fimages/avatar-10.png" alt="" /></a>
            <div className="ass1-comments__content">
      ...
      {/*comment*/}
      <div className="ass1-comments__section">
        <a href="#" className="ass1-comments__avatar ass1-avatar"><img src="/Fimages/avatar-14.png" alt="" /></a>
        <div className="ass1-comments__content">
